...
private func styledFor(_ text: String, colors: [ANSIColor], fd: Int32) -> String {
...
/// Apply ANSI color codes to text destined for stdout.
func styled(_ text: String, _ colors: ANSIColor...) -> String {
    styledFor(text, colors: colors, fd: STDOUT_FILENO)
}

/// Apply ANSI color codes to text destined for stderr.
func styledErr(_ text: String, _ colors: ANSIColor...) -> String {
    styledFor(text, colors: colors, fd: STDERR_FILENO)
}
